...
STRATEGY_KEYS = {
    ...
    "xstmc": StrategyName.XSTMC,
    "sfb": StrategyName.SFB,
    "eyc": StrategyName.EYC,
    "pdmr": StrategyName.PDMR,
    "xmvb": StrategyName.XMVB,
    "lam": StrategyName.LAM,
    "vcd": StrategyName.VCD,
    "rcb": StrategyName.RCB,
    "eha": StrategyName.EHA,
    "pmr": StrategyName.PMR,
    "wsi": StrategyName.WSI,
    "tcf": StrategyName.TCF,
    "rlb": StrategyName.RLB,
    "rlppo": StrategyName.RLPPO,
